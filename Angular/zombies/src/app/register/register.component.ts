...
export class RegisterComponent implements OnInit {
  ...
  guardarUsuario() {
    ...
    element.innerHTML = "";
    console.log(this.username, this.password, this.email, this.perfilPhoto);
  
    this.dataService.agregarUsuario(this.username, this.password, this.email, this.perfilPhoto)
      .subscribe((resultado) => {
